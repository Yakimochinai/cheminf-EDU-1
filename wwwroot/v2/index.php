...
<body>
    <div class="container">
        ...
        <div class="links">
            ...
            <h2 class="title">A1 - Experiments</h2>
            <ul>
...
// Security improvements: Make sure all output is safe to prevent XSS attacks.
// HTML syntax correction: Fix error in HTML title tag (h1 tag not closed).